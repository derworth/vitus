...
class ApplicationTest extends TestCase
{
    ...
    public function test_deploy(): void
    {
        ...
        SSH::assertExecutedContains('cd /home/vitus/'.$this->site->domain);
    ...
    public function test_update_env_file(): void
    {
        ...
        SSH::assertExecutedContains('tee /home/vitus/vitus.test/.env << \'VITO_SSH_EOF\'');
    ...
    public function test_git_hook_deployment(string $provider, array $webhook, string $url, array $payload, bool $skip): void
    {
        ...
        $this->assertEquals('saeed@derworth.com', $deployment->commit_data['email']);
    }
            ...
            [
                ...
                [
                    [
                        ...
                        'committer_email' => 'saeed@derworth.com',
                        'title' => 'test',
