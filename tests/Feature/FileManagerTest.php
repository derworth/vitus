...
class FileManagerTest extends TestCase
{
    ...
    public function test_see_files(): void
    {
        SSH::fake(<<<'EOF'
        total 32
        drwxr-xr-x 7 vitus vitus 4096 Feb 2 19:42 .
        drwxr-xr-x 3 root root 4096 Feb 1 18:44 ..
        drwx------ 3 vitus vitus 4096 Feb 1 18:45 .cache
        drwxrwxr-x 3 vitus vitus 4096 Feb 1 18:45 .config
        -rw-rw-r-- 1 vitus vitus 82 Feb 2 14:13 .gitconfig
        drwxrwxr-x 3 vitus vitus 4096 Feb 1 18:45 .local
        drwxr-xr-x 2 vitus vitus 4096 Feb 2 14:13 .ssh
        drwxrwxr-x 3 vitus vitus 4096 Feb 2 21:25 test.derworth.com
        EOF
        );
    ...
    public function test_create_file(): void
    {
        ...
        drwxr-xr-x 7 vitus vitus 4096 Feb 2 19:42 .
        drwxr-xr-x 3 root root 4096 Feb 1 18:44 ..
        -rw-rw-r-- 1 vitus vitus 82 Feb 2 14:13 test.txt
        EOF
        );
    ...
    public function test_create_directory(): void
    {
        ...
        drwxr-xr-x 7 vitus vitus 4096 Feb 2 19:42 .
        drwxr-xr-x 3 root root 4096 Feb 1 18:44 ..
        drwxr-xr-x 2 vitus vitus 4096 Feb 2 14:13 test
        EOF
        );
