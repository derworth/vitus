...
class CronjobTest extends TestCase
{
    ...
    public function test_delete_cronjob()
    {
        ...
        SSH::assertExecutedContains("echo '' | sudo -u vitus crontab -");
        SSH::assertExecutedContains('sudo -u vitus crontab -l');
    }
    ...
    public function test_create_cronjob()
    {
        ...
        SSH::assertExecutedContains("echo '* * * * * ls -la' | sudo -u vitus crontab -");
        SSH::assertExecutedContains('sudo -u vitus crontab -l');
    }
    ...
    public function test_create_custom_cronjob()
    {
        ...
        SSH::assertExecutedContains("echo '* * * 1 1 ls -la' | sudo -u vitus crontab -");
        SSH::assertExecutedContains('sudo -u vitus crontab -l');
    }
